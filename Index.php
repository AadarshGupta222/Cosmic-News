...
else
{
  $page1=($page*3)-3;
      ...
      <div class="blog-post">
       <a href="WholeNews.php?id=<?php echo $result['news_id'] ?>"><h2 class="blog-post-title"><?php echo $result['title'];?></h2></a>
        ...
        <blockquote>
          <p>Curabitur blandit tempus porttitor. <strong>Nullam quis risus eget urna mollis</strong> ornare vel eu leo. Nullam id dolor id nibh ultricies vehicula ut id elit.<a href="WholeNews.php?id=<?php echo $result['news_id'] ?>"><button class="btn btn-primary btn-sm">Read More</button></a></p>
        </blockquote>
      </div><!-- /.blog-post -->
    <?php } ?>
